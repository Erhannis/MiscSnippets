...
navigator.clipboard.writeText("Description\t"+c2.childNodes[2].textContent.trim()+"\n"+"MFR\t"+a2.childNodes[2].textContent.trim()+"\n"+"LCSC\t"+b2.childNodes[2].textContent.trim()+"\n"+"URL\t"+window.location);